...
function ProviderMarquee() {
  ...
  return (
    <div className="overflow-hidden w-full py-6 relative">
      <div className="absolute left-0 top-0 bottom-0 w-24 z-10" style={{ background: 'linear-gradient(to right, #09090B, transparent)' }} />
      <div className="absolute right-0 top-0 bottom-0 w-24 z-10" style={{ background: 'linear-gradient(to left, #09090B, transparent)' }} />
      <div className="flex">
      ...
      <section ref={heroRef} className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 pt-24 pb-16 text-center overflow-hidden">
        ...
        <motion.div style={{ opacity: heroOpacity, y: heroY }} className="relative z-10 max-w-3xl mx-auto">
          ...
          >
            <Link
              href="/api-njir"
              className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-[#09090B] font-semibold text-sm hover:bg-white/90 transition-all shadow-lg"
            >
              <Key size={15} />
              Masukkan API Key
            </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                <Link
                  href="/api-njir"
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-brand-blue text-[#09090B] font-semibold text-sm hover:bg-brand-blue/90 transition-all"
                >
