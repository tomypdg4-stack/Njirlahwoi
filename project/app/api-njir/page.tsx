        ...
        >
          {TABS.map((t) => (
            <motion.button
              ...
              className={`relative flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm transition-all whitespace-nowrap flex-shrink-0 ${tab === t.key ? `${t.color} font-medium` : 'text-white/35 hover:text-white/60 hover:bg-white/[0.04]'
                }`}
            >
              {tab === t.key && (
                <motion.div
